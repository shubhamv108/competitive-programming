...
import static code.contestpractice.hackerearth.sprinklr.jan2019.InputUtils.splitNextLine;
import static code.contestpractice.hackerearth.sprinklr.jan2019.InputUtils.toInteger;
...
public class One {
    ...
    public static void main(String[] args) {
        ...
        int N = toInteger(line[0]);
        int M = toInteger(line[1]);
        int K = toInteger(line[2]);
